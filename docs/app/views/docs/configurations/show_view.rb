    ...
    class ShowView < ApplicationView
      ...
      def render_prefix_section
        DocsSection do
          ...
          p do
            "You can change the prefix of the modifiers by setting the `prefix` option. This is useful if you want to introduce DaisyUI into a project without clashing with existing CSS classes."
          end
      ...
      def render_custom_modifiers_section
        DocsSection do
          ...
          p do
            "DaisyUI allows you to add custom modifiers to your components. These modifiers are used to add custom styles to your components. For example:"
          end
