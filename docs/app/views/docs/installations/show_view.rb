    ...
    class ShowView < ApplicationView
      ...
      def render_ruby_dependencies_section
        ...
        DocsSection do
          ...
          div do
            span do
              "2. (Optional) Include the DaisyUI module in "
            end
          ...
          p do
            ...
            plain " including DaisyUI in ApplicationComponent if:"
          end

          ul class: "list-disc list-inside" do
            li do
              plain "You have your own component library with the same component names as DaisyUI."
            end
            li do
          ...
          div do
            span do
              plain "In this scenario, including both DaisyUI and your own component library in "
              Code(:ruby, source: "ApplicationComponent", inline: true)
          ...
          p do
            "3. Update your tailwind.config.js file to include DaisyUI styles:"
          end
