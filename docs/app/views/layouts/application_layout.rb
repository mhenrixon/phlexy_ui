  ...
  def view_template(&block)
    ...
    html class: "overscroll-auto sm:overscroll-y-none", data: {theme: request.session[:theme] || :light} do
      head do
        ...
        # OG tags
        meta name: "description", content: "DaisyUI is a component library built with Phlex, a Ruby gem for building fast object-oriented HTML components. On top of DaisyUI, the most popular component library for Tailwind CSS."

        # Facebook meta tags
        meta property: "og:url", content: "https://phlexyui.com/"
        meta property: "og:type", content: "website"
        meta property: "og:title", content: @title || "DaisyUI Docs"
        meta property: "og:description", content: "DaisyUI is a component library built with Phlex, a Ruby gem for building fast object-oriented HTML components. On top of DaisyUI, the most popular component library for Tailwind CSS."
        ...
        meta name: "twitter:title", content: @title || "DaisyUI Docs"
        meta name: "twitter:description", content: "DaisyUI is a component library built with Phlex, a Ruby gem for building fast object-oriented HTML components. On top of DaisyUI, the most popular component library for Tailwind CSS."
